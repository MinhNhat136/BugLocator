...
class Preprocessor:
    ...
    def __init__(self, datas, project_name):
        self.datas = datas
...
class ReportPreprocessor(Preprocessor):
    ...
    def export(self):
        ...
        output_path = f"outputs/{self.project_name}_bug_reports.csv"
...
class SrcPreprocessor(Preprocessor):
    ...
    def export(self):
        ...
        output_path = f"outputs/{self.project_name}_source_code_data.csv"
